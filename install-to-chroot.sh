...
NHSUBDIR="nh370.87-hdf"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/nh370.87-hdf/var/"
# END OF CONFIG
##############################################################################
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-nh370.87-hdf"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-nh370.87-hdf"
