...
NHSUBDIR="nh370.57-hdf"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/nh370.57-hdf/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-nh370.57-hdf"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-nh370.57-hdf"
