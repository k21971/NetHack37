...
NHSUBDIR="nh370.67-hdf"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/nh370.67-hdf/var/"
# END OF CONFIG
##############################################################################
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-nh370.67-hdf"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-nh370.67-hdf"
