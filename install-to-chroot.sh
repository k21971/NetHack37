...
NHSUBDIR="nh370.39-hdf"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/nh370.39-hdf/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-nh370.39-hdf"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-nh370.39-hdf"
