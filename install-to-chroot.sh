...
NHSUBDIR="nh370.50-hdf"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/nh370.50-hdf/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-nh370.50-hdf"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-nh370.50-hdf"
