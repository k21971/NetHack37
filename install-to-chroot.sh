...
NHSUBDIR="nh370.42-hdf"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/nh370.42-hdf/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-nh370.42-hdf"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-nh370.42-hdf"
