...
NHSUBDIR="nh370.84-hdf"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/nh370.84-hdf/var/"
# END OF CONFIG
##############################################################################
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-nh370.84-hdf"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-nh370.84-hdf"
